...
const Footer = () => {
    return (
        <>
            <footer className="footer p-8 lg:p-16 bg-base-200 text-base-content">
                <div>
            ...
            <footer className="footer px-8 p-8 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center mx-auto grid-flow-col">
                    <img className='w-16 h-9' src={logo} alt="" />
                    <p>
                        Copyright © 2023 - All right reserved by ToyVerse Ltd
                    </p>
                </div>
            </footer>
        </>
