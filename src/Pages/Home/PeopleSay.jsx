...
const PeopleSay = () => {
    ...
    return (
        <div className='px-4 md:px-16 my-10'>
            ...
            <h1 className="text-center text-3xl lg:text-7xl font-semibold my-3">What People Say</h1>
            ...
            <div className='grid md:grid-cols-2 gap-5'>
                ...
                <div
                    ...
                    <img className='h-48 md:h-80 rounded-lg' src="https://cdn.shopify.com/s/files/1/3079/6066/files/img19_large.jpg?v=1613731914" alt="" />
                    <div className="card-body p-2 pt-0 md:p-8">
                        <h2 className="text-lg md:text-2xl font-semibold">Domingo Larson</h2>
                        <p className='font-normal md:font-semibold'>Journalist</p>
                ...
                <div data-aos="flip-left"
                    ...
                    data-aos-easing="ease-in-sine"
                    className="card card-side bg-base-100 shadow-xl">
                    <img className='h-48 md:h-80 rounded-lg' src="https://cdn.shopify.com/s/files/1/3079/6066/files/img20_large.jpg?v=1613731914" alt="" />
                    <div className="card-body p-2 pt-0 md:p-8">
                        <h2 className="text-lg md:text-2xl font-semibold">Guillermo Gregory</h2>
                        <p className='font-normal md:font-semibold'>Designer</p>
